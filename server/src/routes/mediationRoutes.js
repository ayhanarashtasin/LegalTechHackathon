...
router.get('/applications/:applicationId/mediation/identity', applicationIdParam, requireRole('DLAO_OFFICER', 'MEDIATOR'), identity.list)
router.post('/applications/:applicationId/mediation/identity/review', applicationIdParam, requireRole('DLAO_OFFICER', 'MEDIATOR'), identity.review)
router.get('/applications/:applicationId/mediation/identity/evidence/:evidenceId', applicationIdParam, requireRole('DLAO_OFFICER', 'MEDIATOR'), identity.evidence)
...
router.post('/applications/:applicationId/mediation/draft/review', applicationIdParam, requireRole('DLAO_OFFICER', 'MEDIATOR'), validateSettlementReview, reviewDraft)
router.post('/applications/:applicationId/mediation/signing-invitations', applicationIdParam, requireRole('DLAO_OFFICER', 'MEDIATOR'), validateSigningInvitation, inviteParty)
router.post('/applications/:applicationId/mediation/signatures', applicationIdParam, requireRole('DLAO_OFFICER', 'MEDIATOR'), validateSignature, sign)
