...
const words = {
  ...
  SUBMITTED_LATE: ['Sent late', 'দেরিতে জমা দেওয়া হয়েছে'], CANCELLED: ['Cancelled', 'বাতিল'], CONTINUED: ['Continued', 'বহাল আছে'], LIFTED: ['Lifted', 'স্থগিতাদেশ তুলে নেওয়া হয়েছে'],
...
const phrases = {
  ...
  'AI flagged possible violence or danger in the caller’s words; a human must judge it.': 'কলারের কথায় সহিংসতা বা বিপদের ইঙ্গিত থাকতে পারে বলে এআই চিহ্নিত করেছে; একজন কর্মকর্তাকে তা যাচাই করতে হবে।',
...
const templates = [
  [/^An urgent fact is recorded \(safety\.urgent revision (\d+), (.+)\)\.$/, (rev, source) => `জরুরি পরিস্থিতির তথ্য নথিভুক্ত আছে (safety.urgent সংশোধন ${num(rev)}, ${say(source.toUpperCase().replaceAll(' ', '_'))})।`],
  ...
  [/^(\d+) referrals were returned\. An authorised human must decide the route; the system does not decide jurisdiction\.$/, (count) => `${num(count)}টি রেফারেল ফেরত এসেছে। এরপর কোন অফিসে যাবে, তা অনুমোদিত কর্মকর্তাকে ঠিক করতে হবে; সিস্টেম এখতিয়ার নির্ধারণ করে না।`],
