...
const words = {
  ...
  MEDIATION_CLAIMED: ['Mediator assigned', 'মধ্যস্থতাকারী দায়িত্ব নিয়েছেন'], MEDIATOR_APPOINTED: ['Mediator appointed by the DLAO officer', 'ডিএলএও কর্মকর্তা মধ্যস্থতাকারী নিয়োগ দিয়েছেন'], MEDIATOR_REMOVED: ['Mediator appointment removed', 'মধ্যস্থতাকারীর নিয়োগ প্রত্যাহার'], DLAO_AS_MEDIATOR: ['Signed by the DLAO officer in the mediator’s place', 'মধ্যস্থতাকারীর স্থলে ডিএলএও কর্মকর্তার স্বাক্ষর'], MEDIATOR_SESSION: ['Signed by the appointed mediator', 'নিযুক্ত মধ্যস্থতাকারীর স্বাক্ষর'], MEDIATION_SCHEDULED: ['Mediation scheduled', 'মধ্যস্থতার সময় নির্ধারিত'],
